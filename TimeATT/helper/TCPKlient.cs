...
namespace TimeATT
{
    public class TCPKlient: IDisposable
    {
        ...
        public delegate void delDataReceived(TCPKlient sender, object data);
        public event delDataReceived DataReceived;
        public delegate void delConnectionStatusChanged(TCPKlient sender, ConnectionStatus status);
        ...
        public TCPKlient(IPAddress ip, int port, bool autoreconnect = true)
        {
            this._IP = ip;
            this._Port = port;
        ...
        {
            var r = result.AsyncState as TCPKlient;
            if (r == null)
