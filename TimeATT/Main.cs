...
namespace TimeATT
{
    ...
    public partial class TimeATT : Form
    {
        ...
        private void BtnLidhu_Click(object sender, EventArgs e)
        {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            string cfgUser = "User:";
            string cfgPass = "Pass:";
            string[] cfgApiKeys = { cfkHost, cfgUser, cfgPass };
            string[] cfgApiValues = { host, user, pass };
            if (host == "" || user == "" || pass == "")
            {
                lbLog.Items.Add(DateTime.Now + ": " + "S'mund te lihen bosh \"host\", \"user\", \"pass\"");
            } else
            {
                chkCfg.ShkruajApiConfig(cfgApiKeys, cfgApiValues);
                btnLogin.Text = "Logout";
                tbHost.Enabled = false;
                tbUser.Enabled = false;
                tbPass.Enabled = false;
                apiHelper.lidhuApi(lbLog, host, user, pass);
            }
        }
